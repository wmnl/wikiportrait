...
<ul>
    ...
    ?>  
    <li><?php if (isset($_SESSION['user'])) echo "<a href=\"$basispad/logout.php\"><i class=\"fa fa-unlock fa-lg\"></i><span>Uitloggen</span></a>"; else echo "<a href=\"$basispad/login.php\"><i class=\"fa fa-lock fa-lg\"></i><span>Inloggen</span></a>"; ?></li>
</ul>   