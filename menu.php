...
<ul>
    <li<?php if ($page == 'index') echo ' class="active"'?>><a href="<?php echo $basispad; ?>/index.php"><i class="fa fa-home"></i><span>Home</span></a></li>
    <li<?php if ($page == 'wizard') echo ' class="active"'?>><a href="<?php echo $basispad; ?>/wizard.php"><i class="fa fa-cloud-upload"></i><span>Insturen</span></a></li>
    <li<?php if ($page == 'upload') echo ' class="active"'?>><a href="<?php echo $basispad; ?>/upload.php"><i class="fa fa-upload"></i><span>Uploaden</span></a></li>
    <?php
