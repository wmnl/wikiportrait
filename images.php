	...
	<table>
		...
		<tbody>
			<?php
				...
				$query = sprintf("SELECT * FROM images WHERE archived = 0 ORDER BY id DESC LIMIT %d, 20", mysql_real_escape_string($start_from));
	...
	<div class="float-right" style="margin-top:10px;">Ga naar pagina:
		<?php
			...
			for ($i=1; $i<=$total_pages; $i++) 
				{ 
					echo "<a href=\"images.php?page=".$i."\" class=\"button\" style=\"margin-left:5px;\">".$i."</a>"; 
				}; 
			?>
	</div>
	<div class="clear"></div>
