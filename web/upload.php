    ...
    <div id="content">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="input-container">
                <label for="file"><i aria-hidden="true" class="fa fa-file-image-o fa-lg fa-fw"></i>Kies 
                    een bestand</label>
                <div class="file">
            ...
            <div class="input-container">
                <label for="title"><i aria-hidden="true" class="fa fa-eye fa-lg fa-fw"></i>Wie staat 
                    er op de foto?</label>
