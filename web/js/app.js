...
// ===== Open-source banner: eenmalig sluiten =====
if ( localStorage.getItem( 'ossBannerDismissed' ) === '1' ) {
    $( '#ossBanner' ).hide();
}

$( document ).on( 'click', '#ossBannerClose', function () {
    $( '#ossBanner' ).fadeOut( 200 );
    try {
        localStorage.setItem( 'ossBannerDismissed', '1' );
    } catch ( e ) { /* private-browsing: negeer */ }
} );