        ...
        if (DB::count() == 0) :
            ...
            <div class="single">
                ...
                <div class="single-box options">
                    ...
                    <?php
                    if ($row['archived'] == 1) {
                        echo "<div class=\"box green\"><i class=\"fa-solid fa-check fa-lg\"></i>Afgehandeld</div>";
                    } elseif ($row['archived'] == 0 && $row['owner'] != 0) {
                        echo "<div class=\"box grey\"><i class=\"fa-solid fa-clock-o fa-lg\"></i>In behandeling</div>";
                    } elseif ($row['archived'] == 0 && $row['owner'] == 0) {
                        echo "<div class=\"box grey\"><i class=\"fa-solid fa-clock-o fa-lg\"></i>In de wachtrij</div>";
                    } else {
                        echo "<div class=\"box red\"><i class=\"fa-solid fa-exclamation-triangle fa-lg\"></i>Status onbekend</div>";
                    }
                    ?>
